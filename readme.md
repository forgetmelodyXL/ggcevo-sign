...
### ✨ 1.1.7
  - 新增兑换限制：除角色冠名权外，每个物品仅限兑换一次
  - 皮肤池/宠物池全部拥有时提示无法抽奖，避免浪费兑换券
  - 新增可兑换道具：赎罪券（消耗 2 兑换券，每月限兑 1 个，背包最大持有 1）
  - 新增 `sign/使用` 指令：使用赎罪券（带确认提示，需在 2 小时内联系管理员）
  - 个人信息新增赎罪券使用记录（最近 3 条）
